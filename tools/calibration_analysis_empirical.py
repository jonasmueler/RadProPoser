...
def main():
    ...
    # NF
    mu_train = np.load("calibration_analysis/mu_val_nf.npy")
    var_train = np.load("calibration_analysis/var_val_nf.npy")
    gt_train = np.load("calibration_analysis/gt_val_nf.npy")
    cdf_train = np.load("calibration_analysis/cdf_val_nf.npy")

    mu_test = np.load("calibration_analysis/mu_testing_nf.npy")
    var_test = np.load("calibration_analysis/var_testing_nf.npy")
    gt_test = np.load("calibration_analysis/gt_testing_nf.npy")
    cdf_test = np.load("calibration_analysis/cdf_testing_nf.npy")


    # gauss gauss
    #mu_train = np.load("calibration_analysis/mu_val_gauss_gauss.npy")
    #var_train = np.load("calibration_analysis/var_val_gauss_gauss.npy")
    #gt_train = np.load("calibration_analysis/gt_val_gauss_gauss.npy")
    #cdf_train = np.load("calibration_analysis/cdf_val_gauss_gauss.npy")#

    #mu_test = np.load("calibration_analysis/mu_testing_gauss_gauss.npy")
    #var_test = np.load("calibration_analysis/var_testing_gauss_gauss.npy")
    #gt_test = np.load("calibration_analysis/gt_testing_gauss_gauss.npy")
    #cdf_test = np.load("calibration_analysis/cdf_testing_gauss_gauss.npy")
    ...
    visualizer.quantify_improvement_with_holdout(mu_train, var_train, gt_train, cdf_train,
                                                 mu_test, var_test, gt_test, cdf_test)
    #visualizer.run_with_holdout(mu_train, var_train, gt_train, cdf_train,
    #                                             mu_test, var_test, gt_test, cdf_test)
